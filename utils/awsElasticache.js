...
class awsElasticache {
    ...
    set(key, val) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_set = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} set ${key} '${val_json}'`;
        console.log("set() cmd: ", `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} set ${key} [skip_val_debug]`);
    ...
    get(key) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_get = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} get ${key}`;
    ...
    hset(key, val) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        let cmd_hset = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} hset ${this.hash} ${key} '${val_json}'`;
        console.log("hset() cmd: ", `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} hset ${this.hash} ${key} [skip_val_json]`);
    ...
    hget(key) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_hget = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} hget ${this.hash} ${key}`;
    ...
    hdel(key) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_hdel = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} hdel ${this.hash} ${key}`;
    ...
    hgetall() {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_hgetall = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} hgetall ${this.hash}`;
    ...
    del(key) {
      ...
      return new Promise(async (resolve, reject) => {
        console.log("del() called");  
        var cmd_del = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} del ${key}`;
    ...
    sadd(element) {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_sadd = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} sadd ${this.set_key} ${element}`;
    ...
    smembers() {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        var cmd_smembers = `${this.redis_cli_script} -c --tls -h ${this.redis_cluster_host} -p ${this.redis_cluster_port} smembers ${this.set_key}`;
